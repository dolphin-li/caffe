...
namespace caffe {
	...
	Layer<Dtype>* GetLayer(const LayerParameter& param) {
		...
		case LayerParameter_LayerType_BGR2LUMA:
			return new Bgr2LumaLayer<Dtype>(param);
		case LayerParameter_LayerType_PATCH_SAMPLE:
			return new PatchSampleLayer<Dtype>(param);
		case LayerParameter_LayerType_ADD_NOISE:
			return new AddNoiseLayer<Dtype>(param);
		case LayerParameter_LayerType_PER_SAMPLE_SCALE:
			return new PerSampleScaleLayer<Dtype>(param);
		case LayerParameter_LayerType_CALC_COV:
			return new CalcCovLayer<Dtype>(param);
